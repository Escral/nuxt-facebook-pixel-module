...
class Fb {
   ...
   * @param {object} serverParameters
   */
  query (cmd, option, parameters = null, serverParameters = null) {
    if (this.options.debug)
      log('Command:', cmd, 'Option:', option, 'Additional parameters:', parameters, 'Server parameters:', serverParameters)
    ...
    if (!parameters) {
      if (! serverParameters)
        ...
        this.fbq(cmd, option, null, serverParameters)
    } else {
      this.fbq(cmd, option, parameters, serverParameters)
    }
  }
}
